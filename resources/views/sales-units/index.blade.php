...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-between align-items-center mb-4">
            <div class="col-auto">
                <h1><i class="fas fa-box"></i> Sales Units</h1>
            </div>
            <div class="col-auto">
                <a href="{{ route('sales-units.create') }}" class="btn btn-primary">
                    <i class="fas fa-plus"></i> Add New Sales Unit
                </a>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="sales-units-table" class="table table-striped table-hover table-bordered" style="width:100%">
                        ...
                        <tbody>
                        {{-- $units variable passed from SalesUnitController::index --}}
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="Unit Actions">
                                        <a href="{{ route('sales-units.show', $unit->id) }}" class="btn btn-sm btn-info me-1" title="View">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('sales-units.edit', $unit->id) }}" class="btn btn-sm btn-primary me-1" title="Edit">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    Are you sure you want to delete the Sales Unit: <strong>{{ $unit->name }}</strong>?
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                                    {{-- Note: Route model binding uses salesUnit, not unit --}}
                                                    <form action="{{ route('sales-units.destroy', $unit->id) }}" method="POST" class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
